...
module "ThreadLegacy" {
  requires cplusplus
  module "TWin32Condition.h" { header "TWin32Condition.h" export * }
  module "TWin32Mutex.h" { header "TWin32Mutex.h" export * }
  module "TWin32Thread.h" { header "TWin32Thread.h" export * }
  module "TWin32ThreadFactory.h" { header "TWin32ThreadFactory.h" export * }
...
module "CoreLegacy" {
  ...
  module "TWinNTSystem.h" { header "TWinNTSystem.h" export * }
